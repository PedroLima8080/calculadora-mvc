...
Possui funções que guardam operações passadas, eventos de teclado, comandos de copiar e colar, funções que substituem o operador passado para o atual, calcula resultados quando atinge 2 operadores na mesma equação e etc.
